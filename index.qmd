...
##  {#nasa-beach-ball .center data-menu-title="NASA Beach Ball" background-image="images/nasa-earth-fleet.png" background-size="contain" background-color="#000000"}
...
Onboarding: <br>invite participation, <br>info lives outside email
...
## Putting a focus on documentation has enabled<br>other organizations<br> to reuse this approach {background="#FAE3E3"  .centered .center}
