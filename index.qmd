...
::: fragment
**Purpose today:** help you document things effectively & hear stories of how documentation can be help teams be efficient, productive, and less lonely. 
...
::: {.white-bg}
**10-min stories** - repeatable strategies (from NASA Openscapes & beyond [TL;DR](TODO EDITORIAL REF))
:::

:::

::: notes
it's suppsed to be helpful
...
Break down documenation as an otherwise big and looming task.
...
::: ref-text
Lowndes et al, [Shifting institutional culture to develop climate solutions with Open Science](TODO REF)
:::
...
::: columns
::: {.column width="40%"}
**Documenting things requires intention and time.**
...
Openscapes core team (Erin Robinson, Ileana Fenwick, Stefanie Butland), NASA Earthdata, NOAA Fisheries, Cal EPA, Pathways Mentors, Openscapes community

Open source/science community far and wide and always

Sam Csik aka CSS architect
...
![](images/rios-kim-tomato-plant-kinder-science.png){fig-alt="a digital crayon drawing of a tomato plant in the middle and a colorful circle around it connecting different concepts clockwise, starting at the roots. The roots says Culture, the watering can and toolbox says Technical Infrastructure, the sun says Values, the leaves say Social Infrastructure, and the final basket of tomatoes says Relevant, rigourous, insightful science" fig-align="right" width="50%"}
