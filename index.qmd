...
## Documenting things doesn't have to be painful {.takeaway background="#53C9DF"}
...
::: {.yellow-bg}
**5-min lightening talk** - practical tips (inspired by [Jenny Bryan's Naming Files](https://github.com/jennybc/how-to-name-files#how-to-name-files) 💙)
:::

<br-smaller>

::: {.white-bg}
**10-min stories** - repeatable strategies from NASA Openscapes & beyond (TL;DR is THIS EDITORIAL))
:::
...
{{< fa angle-right >}} Have an audience

{{< fa angle-right >}} Design for readability, accessibility, and navigation
:::
...
## {{< fa angle-right >}} Have an audience {background="#FFF6E1"}
...
## {{< fa angle-right >}} Design for readability, accessibility, & navigation {background="#FFF6E1"}
...
Diagrams, screenshots, photos help with documentation. 

TODO: Allison Horst's artwork or Elliot's photos
There is a giant arrow towards the thing 
...
::: notes
let me remind you that NASA has a ton of 
Maybe Joel Scott's/Joels slide: with the satellites
...
##  What's possible from this {background="#53C9DF" .centered}
...
## Putting a focus on documentation has enabled <br>the NASA Openscapes community to grow<br>through intentional onboarding over 3 years {background="#d2e3f3" .centered}
...
## Putting a focus on documentation has enabled other organizations reuse this approach {background="#FAE3E3" .centered}
...
## TODO Rework - tomato plant, editorial Documenting things ... 
